          ...
          <form className={styles.promptsWrapper} onSubmit={handleSubmit}>
            {prompts.map((prompt, index) =>
              prompt.isUploadFile ? (
                ...
                <PromptCard key={index} question={prompt.question} example={prompt.example} nomeVariavel={prompt.nomeVariavel} campoObrigatorio={prompt.campoObrigatorio} onChange={handleChange} />
              )
            )}
